...
CA[int(numCells/2)][int(numCells/2)] =1
CA[int(numCells/2)+1][int(numCells/2)] =1


#matriz para contar tempo de recuperacao
R = [[0 for x in range(numCells)] for y in range(numCells)]

rec = 15 #iteracoes para recuperação
propagacao = 2 #individuos na vizinhança suficiente para propagação
#probabilidade = 5 #probabilidade de "nascer" com a doença
